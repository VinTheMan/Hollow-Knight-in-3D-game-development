using UnityEngine;
	...
	public class ThirdPersonCharacter : MonoBehaviour
	{
        ...
        public PlayerControl.PlayerScript.PlayerSetting heroData ;
		...
		public void Move(Vector3 move, bool jump)
		{
			...
			if( !m_Animator.GetCurrentAnimatorStateInfo(0).IsName("impact") &&
			//  !m_Animator.GetCurrentAnimatorStateInfo(0).IsName("jump") &&
			 !m_Animator.GetCurrentAnimatorStateInfo(0).IsName("swing")
			  ) {
		...
		void HandleGroundedMovement(bool jump)
		{
			...
			if (jump) //&& m_Animator.GetCurrentAnimatorStateInfo(0).IsName("idle"))
			{
				// jump!
    ...
    private void OnTriggerEnter(Collider col) {
        if ( col.tag == "Geo" ) {
            heroData.SetOutcomeGeo(heroData.GetOutcomeGeo() + 1);
            Destroy(col) ;
        }
    }
}
